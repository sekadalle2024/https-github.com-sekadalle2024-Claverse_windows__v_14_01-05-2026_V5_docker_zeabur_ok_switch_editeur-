...
export class ClaraDatabase {
   ...
   */
  async updateClaraSession(
    sessionId: string,
    updates: Partial<ClaraChatSession>
  ): Promise<void> {
   ...
   */
  async getRecentClaraSessions(
    limit: number = 20
  ): Promise<ClaraChatSession[]> {
   ...
   */
  async getRecentClaraSessionsLight(
    limit: number = 20,
    offset: number = 0
  ): Promise<ClaraChatSession[]> {
